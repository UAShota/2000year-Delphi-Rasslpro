object fmTagComposition: TfmTagComposition
  Left = 337
  Top = 408
  Width = 649
  Height = 380
  Caption = #1048#1085#1075#1088#1080#1076#1080#1077#1085#1090#1099' '#1087#1088#1086#1076#1091#1082#1090#1072
  Color = clBtnFace
  ...
  object ADOTagProduct: TADODataSet
    Connection = ModuleData.ADOConnection
    CursorType = ctStatic
    BeforePost = ADOTagProductBeforePost
    CommandText = 'select * from TAG_COMPOSITION where ID_PRODUCT=:ID'
    Parameters = <
      item
        Name = 'ID'
    ...
    Left = 296
    Top = 112
    object ADOTagProductNAME: TStringField
      ...
      KeyFields = 'ID_INGRIDIENT'
      Lookup = True
    end
    object ADOTagProductCOUNT: TIntegerField
      DisplayLabel = #1050#1086#1083#1080#1095#1077#1089#1090#1074#1086
      FieldName = 'COUNT'
    end
    object ADOTagProductID_PRODUCT: TIntegerField
      FieldName = 'ID_PRODUCT'
      Visible = False
    end
    object ADOTagProductID_INGRIDIENT: TIntegerField
      FieldName = 'ID_INGRIDIENT'
      Visible = False
    end
  end
  object DSTagProduct: TDataSource
    DataSet = ADOTagProduct
    Left = 296
    Top = 144
  end
