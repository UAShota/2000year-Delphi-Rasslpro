object fmRefIngredient: TfmRefIngredient
  Left = 305
  Top = 208
  Align = alClient
  BorderStyle = bsNone
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1080#1085#1075#1088#1077#1076#1080#1077#1085#1090#1086#1074
  ClientHeight = 369
  ClientWidth = 655
  Color = clBtnFace
  ...
  object ADODataSet: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 'select * from REF_INGREDIENT'
    Parameters = <>
    Left = 296
    Top = 112
    object ADODataSetID_INGREDIENT: TAutoIncField
      DisplayLabel = #8470
